...
const Map<String, Map<String, VersionedMarkers>> regionMarkersByRegion = {
  'kanto': {
    ...
    'route-7': {
      'red': RegionMarker(704.0, 384.0, 'Route 7', 'Red'),
      'blue': RegionMarker(704.0, 384.0, 'Route 7', 'Blue'),
      'yellow': RegionMarker(704.0, 384.0, 'Route 7', 'Yellow'),
      'firered': RegionMarker(704.0, 384.0, 'Route 7', 'FireRed'),
      'leafgreen': RegionMarker(704.0, 384.0, 'Route 7', 'LeafGreen'),
      'lets-go-pikachu': RegionMarker(704.0, 384.0, 'Route 7', "Let's Go Pikachu"),
      'lets-go-eevee': RegionMarker(704.0, 384.0, 'Route 7', "Let's Go Eevee"),
      'default': RegionMarker(704.0, 384.0, 'Route 7', 'Default'),
    },
    'route-8': {
